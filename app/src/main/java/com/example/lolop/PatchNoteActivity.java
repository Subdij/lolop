...
public class PatchNoteActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportFragmentManager().beginTransaction().runOnCommit(() -> {
    ...
    private void setupWebView() {
        ...
        binding.webView.setWebViewClient(new WebViewClient() {
            ...
            public void onReceivedHttpError(WebView view, android.webkit.WebResourceRequest request,
                ...
                if (request.getUrl().toString().equals(constructPatchUrl(currentVersion))
    ...
    private String getPatchNotesParams(boolean tagsOnly) {
        ...
        // "en-gb" is generally safer for global consistency with FR structure on LoL
        // site.
