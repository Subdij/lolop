...
public class OverlayItemAdapter extends RecyclerView.Adapter<OverlayItemAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_overlay_grid, parent, false);
